...
$Links = @(
    ...
    @("r2-p2",1,"r6-pe2",5), @("r2-p2",4,"r3-p3",4), @("r2-p2",3,"r4-p4",2),
    @("r2-p2",5,"r5-pe1",5),
    @("r3-p3",1,"r7-pe3",1), @("r3-p3",2,"r4-p4",3), @("r3-p3",5,"r8-pe4",1),
    @("r4-p4",6,"r7-pe3",2),
    @("r4-p4",7,"r8-pe4",2),
...
$logEntry = @{ sessionId = "984e35"; runId = "gen-configs-r3"; hypothesisId = "H1"; location = "generate-configs.ps1"; message = "r3-p3 port map from LINKS"; data = @{ mapping = $r3Map }; timestamp = $ts } | ConvertTo-Json -Compress
