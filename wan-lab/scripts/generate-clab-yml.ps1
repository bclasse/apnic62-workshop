...
$links = @(
    ...
    '    - endpoints: ["r1-p1:e1-3", "r3-p3:e1-3"]',
    '    - endpoints: ["r1-p1:e1-4", "r4-p4:e1-4"]',
    '    - endpoints: ["r1-p1:e1-5", "r6-pe2:e1-5"]',
    '    - endpoints: ["r2-p2:e1-1", "r6-pe2:e1-1"]',
    '    - endpoints: ["r2-p2:e1-4", "r3-p3:e1-4"]',
    '    - endpoints: ["r2-p2:e1-3", "r4-p4:e1-3"]',
    '    - endpoints: ["r2-p2:e1-5", "r5-pe1:e1-5"]',
    '    - endpoints: ["r3-p3:e1-2", "r4-p4:e1-2"]',
    '    - endpoints: ["r3-p3:e1-5", "r8-pe4:e1-1"]',
    '    - endpoints: ["r3-p3:e1-1", "r7-pe3:e1-1"]',
    '    - endpoints: ["r4-p4:e1-5", "r7-pe3:e1-2"]',
    '    - endpoints: ["r4-p4:e1-1", "r8-pe4:e1-2"]',
