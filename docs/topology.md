...
The APNIC62 WAN lab uses the **12-router topology** of the workshop guide's segment routing lab environment (Figure 1). Labs 4 and 5 use the EVPN lab environment (Figure 2), which is six of these same routers.
...
![Segment routing lab topology](images/topology-sr.png)
...
### R1-P1 interface mapping (Figure 1)
...
### R3-P3 / R4-P4 / R7-PE3 / R8-PE4 (Figure 1)
...
- [Lab guide router mapping](router-naming.md)
